...
function test() {
    return __awaiter(this, void 0, void 0, function () {
        var mainPsxUrl, phone, pass, res, createData, loginRes, loginData;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    mainPsxUrl = 'https://www.psx.ng';
                    phone = '09000000001';
                    pass = 'password123';
                    return [4 /*yield*/, fetch("".concat(mainPsxUrl, "/api/staff"), {
                            method: 'POST',
                            headers: {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, fetch("".concat(mainPsxUrl, "/api/auth/login"), {
                            method: 'POST',
